                    ...
                    <div class="col-sm-12">
                        <form role="form" onsubmit="return false;" id="formBusqueda" class="form-horizontal centered">
                            <div class="form-group" id="groupptCodigo">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="ptCodigo" placeholder="Digite el código del puesto">
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group" id="groupptDescripcion">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="ptDescripcion" placeholder="Digite el nombre del puesto">
                                </div>
                                <div class="col-sm-4">
