<%-- 
    Document   : ADMINISTRAR_PROCESO_FINALIZACION_JSP
...
<html>
    <head>
        <title>Administrar Procesos de Finalización de Teletrabajo</title>
        ...
        <script src="js/ADMINISTRAR_PROCESO_FINALIZACION_JS.js" type="text/javascript"></script>
    </head>
    <body>
        <%@ include file="/HeaderJSP.jsp" %>
        <div class="container">
            <div class="panel panel-default">
                <div class="panel-heading"><h3>Administrar Procesos de Finalización de Teletrabajo</h3></div>
