                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" role="tabpanel" id="step5">
                                        ...
                                        <ul class="list-inline">
                                            ...
                                            <li>
                                                <br>
                                                <a href="DC_DOCUMENTACION_Servlet">Descargar Formulario</a>
                                            </li>
                                            <br>
                                            <br>
                                            <li>
                                                <h5>Adjuntar formulario requerimientos tecnológicos</h5>
                                            </li>
                                            <br>
                                            <li>
                                                <br>
                                                <label class="btn btn-info btn-file">
                                                    Adjuntar archivo <input type="file" style="display: none;" id="requerimientos">
                                                </label>
                                                <label id="archivorequerimientos"></label>
                                            </li>
                                            <li>
                                                <br>
                                                <h5>Observación:</h5>
                                            ...
                                            <br>
                                            <li><button type="button" class="btn btn-success next-step" style="position: absolute; right: 100px" id="guardar5">Avanzar Proceso</button></li>
                                        </ul>
                                    </div>
                                    <!--PANEL ESTADO 6-->
                                    ...
                                    <div class="tab-pane" role="tabpanel" id="step7">
                                        ...
                                        <ul class="list-inline">
                                            ...
                                            <li>
                                                <br>
                                                <label class="btn btn-info btn-file">
                                                    Adjuntar archivo <input type="file" style="display: none;" id="adenda">
                                                </label>
                                                <label id="archivoadenda"></label>
                                            </li>
                                            <li>
                                                <br>
                                                <h5>Observación:</h5>
