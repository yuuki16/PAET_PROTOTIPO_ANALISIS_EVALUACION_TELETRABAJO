                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane" role="tabpanel" id="step2">
                                            ...
                                            <ul class="list-inline">
                                                        ...
                                                        <table class="table" id="tablaActividades">
                                                            ...
                                                            <tbody id= "actividades">
                                                                <tr id="act0">
                                                                    ...
                                                                    <td><input type="radio" name="alineamiento0"></td>
                                                                    <td><input type="radio" name="alineamiento0"></td>
                                                                    <td><input type="radio" name="alineamiento0"></td>
                                                                    <td><input type="radio" name="alineamiento0"></td>
                                                                    <td><input type="checkbox" value="0" name="caracteristicas0" onclick="verificarActividad('0')"></td>
                                                                    <td><input type="checkbox" value="0" name="caracteristicas0" onclick="verificarActividad('0')"></td>
                                                                    <td><input type="checkbox" value="0" name="caracteristicas0" onclick="verificarActividad('0')"></td>
                                                                    <td><input type="checkbox" value="0" name="caracteristicas0" onclick="verificarActividad('0')"></td>
                                                ...
                                                <br>
                                                <br>
                                                <li><button type="button" class="btn btn-success next-step" style="position: absolute; right: 16px">Avanzar Proceso</button></li>
                                            </ul>
                                        </div>
