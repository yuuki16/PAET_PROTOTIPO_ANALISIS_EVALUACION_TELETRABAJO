 ...
 * @author Michelle
 */
public class PAET_DI_TT_DIA_TELETRABAJADOR_BL extends BaseBL implements IBaseBL<PaetDiTtDiaTeletrabajador, BigDecimal>{

    public PAET_DI_TT_DIA_TELETRABAJADOR_BL()
    {
        super();
    }
