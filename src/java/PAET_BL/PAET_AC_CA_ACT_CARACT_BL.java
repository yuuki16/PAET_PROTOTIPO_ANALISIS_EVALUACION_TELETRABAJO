 ...
 * @author Michelle
 */
public class PAET_AC_CA_ACT_CARACT_BL extends BaseBL implements IBaseBL<PaetAcCaActCaract, BigDecimal>{

    public PAET_AC_CA_ACT_CARACT_BL()
    {
        super();
    }
    ...
    @Override
    public List<PaetAcCaActCaract> findAll(String className) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
